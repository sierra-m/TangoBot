...
const COLLECTION = [
  ...
  { id: uuid(), label: "Turn Left", instruction: "ST{{dir}}800DEL{{delay}}DR0", value: 1000, min: 0, max: 5000, type: 'STL' },
  { id: uuid(), label: "Turn Right", instruction: "ST{{dir}}800DEL{{delay}}DR0", value: 1000, min: 0, max: 5000, type: 'STR' },
